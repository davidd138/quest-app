...
import { CREATE_QUEST } from '@/lib/graphql/mutations';
...
function NewQuestContent() {
  ...
  const { execute: createQuest, loading: saving } = useMutation<Quest>(CREATE_QUEST);
  ...
  const updateField = <K extends keyof CreateQuestInput>(field: K, value: CreateQuestInput[K]) => {
      ...
      <motion.div variants={itemVariants} className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          ...
          <p className="text-slate-400 text-sm mt-1">
            Design an immersive quest experience
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <input
                ...
                onChange={(e) =>
                  updateField('location', { ...formData.location, name: e.target.value })
                }
                className="w-full px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-violet-500/50"
              />
              <input
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-white text-sm focus:outline-none focus:border-violet-500/50"
                placeholder="outdoor, history, beginner..."
              />
            </div>
          </div>
        </Card>
