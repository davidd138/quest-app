...
class FrontendStack(cdk.Stack):
    def __init__(self, scope: Construct, construct_id: str, env_name: str, **kwargs):
        ...
        site_bucket = s3.Bucket(
            self, "SiteBucket",
            bucket_name=f"{env_name}-qm-frontend-{self.account}",
        ...
        response_headers_policy = cloudfront.ResponseHeadersPolicy(
            ...
            response_headers_policy_name=f"{env_name}-qm-security-headers",
        ...
        cdk.CfnOutput(
            ...
            export_name=f"{env_name}-qm-bucket-name",
        )
        cdk.CfnOutput(
            self, "CloudFrontUrl",
            value=f"https://{distribution.distribution_domain_name}",
            export_name=f"{env_name}-qm-cloudfront-url",
        )
        cdk.CfnOutput(
            self, "DistributionId",
            value=distribution.distribution_id,
            export_name=f"{env_name}-qm-distribution-id",
        )
